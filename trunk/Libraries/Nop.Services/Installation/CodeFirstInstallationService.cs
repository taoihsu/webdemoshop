    ...
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        protected virtual void InstallProducts(string defaultUserEmail)
        {
            ...
            var productAdidasShoe = new Product()
            {
                ...
                ShortDescription = "Now there are even more reasons to love this training favorite. An improved last, new step-in sockliner and the smooth control of 3-D ForMotionEdeliver a natural, balanced touchdown that feels better than ever.",
